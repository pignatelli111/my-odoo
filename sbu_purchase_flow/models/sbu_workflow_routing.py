...
SBU_WORKFLOW_ROUTE_SELECTION = [
    ('VC/VS', 'VT / Vetro (VC-VS)'),
    ('ZANZ', 'Zanzariere'),
    ('OSC', 'OSC / Oscuranti'),
    ('ST', 'ST / Staffe'),
    ('PAN', 'PAN / Pannelli'),
    ('LA', 'LA / Lamiera alluminio'),
    ('LZ', 'LZ / Lamiera zincata (carpenteria)'),
    ('PRF', 'PRF / Profili'),
    ('FT/FTF', 'FT / Serramenti'),
    ('SE', 'SE / Telai'),
    ('ASS', 'ACO / Montaggio (ASS)'),
    ('ACC', 'ACO / Accessori (ACC)'),
    ('GUA', 'ACO / Guarnizioni (GUA)'),
    ('POS', 'ACP / Posa installazione'),
    ('TRN', 'LDS / Trasporto'),
    ('PM', 'PM / Project management'),
    ('CNT', 'CNT / Costi cantiere'),
    ('EXT', 'EXT / Extra'),
]
...
SBU_WIZARD_ROUTE_SELECTION = [
    ('LA', 'LA — Lamiera alluminio'),
    ('LZ', 'LZ — Carpenteria / lamiera zincata'),
    ('ST', 'ST — Staffe'),
    ('PAN', 'PAN — Pannelli'),
    ('OSC', 'OSC — Oscuranti'),
    ('VC/VS', 'VT — Vetro / VC-VS'),
